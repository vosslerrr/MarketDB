...
ImGuiObject::ImGuiObject(const char* l_name, const char* l_label, ImFont* l_font)
{
	m_name = l_name;
	m_label = l_label;
	m_font = l_font;
...
void ImGuiObject::drawTextBox(ImVec2 l_windowPos)
{
...
void ImGuiObject::drawButton(ImVec2 l_windowPos)
{
	ImGui::SetNextWindowPos(l_windowPos);
	ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(0.f, 0.f, 0.f, 1.f));
...
void ImGuiObject::drawHeaderButton(ImVec2 l_windowPos)
{
	ImGui::SetNextWindowPos(l_windowPos);
